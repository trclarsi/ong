...
import { Play, Instagram, Facebook, Quote, ChevronRight } from 'lucide-react';
    ...
    >
      ...
      <section className="relative h-screen flex items-center overflow-hidden bg-neutral-900">
        <motion.div style={{ opacity }} className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1493125590504-03706037748a?auto=format&fit=crop&q=80&w=2000" 
          ...
          <div className="max-w-6xl">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.8 }} className="flex items-start gap-8 mb-16 max-w-2xl border-l-2 border-amber-500 pl-8">
              <p className="text-xl md:text-3xl font-light text-neutral-300 leading-relaxed">
                L'expertise <span className="text-white italic">technique</span> au service de votre <span className="font-bold text-white">marketing digital</span> et de votre <span className="font-bold text-white uppercase tracking-widest text-lg md:text-xl ml-2">image de marque</span>.
              </p>
            </motion.div>

            <div className="flex flex-wrap items-center gap-10">
              <Link to="/portfolio" className="px-12 py-6 bg-white text-black text-[11px] font-bold uppercase tracking-[0.3em] hover:bg-amber-600 hover:text-white transition-all shadow-xl">
                Explorer le portfolio
              </Link>
              <Link 
                to="/contact"
                className="group flex items-center gap-6 text-[11px] font-bold uppercase tracking-[0.4em] text-white transition-all"
              >
                <div className="relative py-1">
                  ME CONTACTER
                  <span className="absolute bottom-0 left-0 w-0 h-[2px] bg-amber-500 transition-all duration-500 group-hover:w-full"></span>
                </div>
                <div className="w-12 h-12 rounded-full border-2 border-amber-500 flex items-center justify-center text-amber-500 group-hover:bg-amber-500 group-hover:text-black transition-all duration-500">
        ...
        <div className="container mx-auto px-6">
          <div className="mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-amber-500">Expertise</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div 
                key={idx}
                whileHover={{ y: -10 }}
                className="relative aspect-[3/4] overflow-hidden group cursor-pointer shadow-2xl"
              >
                ...
                <div className="absolute bottom-10 left-8 right-8">
                  ...
                  <p className="text-[11px] text-neutral-400 mb-6 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 font-light leading-relaxed">
                    {item.desc}
                  </p>
            ...
            <div className="relative flex justify-center">
              <div className="relative w-full max-w-md">
                ...
                <div className="absolute -bottom-6 -right-6 bg-amber-500 p-8 text-black shadow-xl z-20 min-w-[160px] text-center">
                   ...
                   <p className="text-[9px] font-black uppercase tracking-widest leading-tight">Années de passion</p>
                </div>
             ...
             <div className="bg-[#111111] p-16 md:p-24 relative overflow-hidden shadow-2xl rounded-sm text-white">
                ...
                <div className="relative z-10 text-center">
                   ...
                   <div className="space-y-2">
                      <p className="text-xs font-bold uppercase tracking-[0.3em]">Sophie Laurent</p>
                      <p className="text-[9px] font-bold uppercase tracking-[0.3em] text-amber-500">Directrice Artistique, Mode Montréal</p>
                   </div>
                </div>
             </div>
          </div>
